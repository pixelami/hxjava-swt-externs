...
@:native("org.eclipse.swt.widgets.Slider")
/**
 ...
 */
extern class Slider extends org.eclipse.swt.widgets.Control 
{
/**
 ...
 * </ul>
 */
	public function setThumb(value:Int):Void;
/**
 ...
 * </ul>
 */
	public function setPageIncrement(value:Int):Void;
/**
 ...
 * </ul>
 */
	public function setIncrement(value:Int):Void;
/**
 ...
 * </ul>
 */
	public function setValues(selection:Int,minimum:Int,maximum:Int,thumb:Int,increment:Int,pageIncrement:Int):Void;
/**
 * Returns the amount that the receiver's value will be
 * modified by when the up/down (or right/left) arrows
 * are pressed.
