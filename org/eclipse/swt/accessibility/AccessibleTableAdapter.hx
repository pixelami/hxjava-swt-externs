...
@:native("org.eclipse.swt.accessibility.AccessibleTableAdapter")
/**
 ...
 * @since 3.6
 */
extern class AccessibleTableAdapter implements org.eclipse.swt.accessibility.AccessibleTableListener
{
